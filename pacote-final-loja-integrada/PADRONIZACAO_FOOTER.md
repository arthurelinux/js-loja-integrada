...
Se o footer nativo continuar variando entre páginas, teste a versão independente do pacote. Ela não usa Vue: no mobile, remove o `#rodape` nativo, cria um elemento independente com JavaScript puro e monitora recriações do DOM pela Loja Integrada. No desktop, preserva o footer nativo.
